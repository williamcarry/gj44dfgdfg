...
// Download non-product images referenced in src/pages/DirectDeliveryPage.vue
// Saves them to public/frondend/images/DirectDeliveryPage and replaces URLs in the vue file
// Usage: node scripts/download-direct-delivery-images.js
...
function isProductImageUrl(url) {
  // Exclude known product image hosts/paths (Resources/GoodsImages etc.)
  // You can extend this list if necessary.
...
async function main() {
  ...
  for (const url of candidates) {
    try {
      ...
      // store replacement path relative to public root
